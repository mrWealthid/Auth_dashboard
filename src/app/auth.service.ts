...
export class AuthService {
  ...
  createSession(tourId) {
    return this._http.get(`http://127.0.0.1:3000/api/v1/bookings/checkout-session/${tourId}`, {
      observe: 'body',
      headers: new HttpHeaders().set('Authorization', 'Bearer ' +
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjVjOGExZDViMDE5MGIyMTQzNjBkYzA1NyIsImlhdCI6MTY4MzIwODM4OSwiZXhwIjoxNjgzMjA5NTg5fQ.6acVEPnZw8gcrjyahg6pt8UoIENxrTVabsNNSMTlmzQ')
